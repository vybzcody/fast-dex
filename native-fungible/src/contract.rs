...
use linera_sdk::{
    abis::fungible::{
        FungibleOperation, FungibleResponse, FungibleTokenAbi, InitialState, Parameters, Account as AbiAccount,
    },
...
impl NativeFungibleTokenContract {
    ...
    fn normalize_account(&self, account: AbiAccount) -> BaseAccount {
        BaseAccount {
